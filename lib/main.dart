import 'package:coffeshop/details_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Container(
              child: Text('Let\'s select the best taste for your next coffee break!',style: TextStyle(
                fontFamily: 'nunito',
                fontSize: 17.0,
  ...
  _coffeeListCard(String imgPath,String coffeeName,
